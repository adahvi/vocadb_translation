...
public  class ColorPickerUtil extends View {
	...
	public ColorPickerUtil(Context context) {
		super(context);
		this.context = context;
		init();
	}

	public ColorPickerUtil(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		init();
	}
			...
			case MotionEvent.ACTION_UP:
				if (mTrackingCenter) {
				 ...
				 //      mListener.colorChanged(mCenterPaint.getColor());
						onColorSelectedListener.onColorChanged(mCenterPaint.getColor());
					}
